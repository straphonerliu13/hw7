...
firebase.auth().onAuthStateChanged(async function(user) {
    ...
    if (user) {
        ...
        document.querySelector('.movies').insertAdjacentHTML('beforebegin',`
            <h1 class="px-20 pt-12  font-bold text-2xl text-white">Welcome, ${user.displayName}!</h>
        `)
        ...
        let apiKey = '95f530e35223d79fbe74b4289c1ecbc5'
